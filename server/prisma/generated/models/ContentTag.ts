...
export type ContentTagWhereInput = {
  ...
  content_id?: Prisma.StringFilter<"ContentTag"> | string
  tag_id?: Prisma.StringFilter<"ContentTag"> | string
...
export type ContentTagWhereUniqueInput = Prisma.AtLeast<{
  content_id_tag_id?: Prisma.ContentTagContent_idTag_idCompoundUniqueInput
  AND?: Prisma.ContentTagWhereInput | Prisma.ContentTagWhereInput[]
  OR?: Prisma.ContentTagWhereInput[]
  NOT?: Prisma.ContentTagWhereInput | Prisma.ContentTagWhereInput[]
  content_id?: Prisma.StringFilter<"ContentTag"> | string
...
export type ContentTagScalarWhereWithAggregatesInput = {
  ...
  content_id?: Prisma.StringWithAggregatesFilter<"ContentTag"> | string
  tag_id?: Prisma.StringWithAggregatesFilter<"ContentTag"> | string
}
...
export type ContentTagContent_idTag_idCompoundUniqueInput = {
  content_id: string
  tag_id: string
}
...
export type ContentTagOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"content_id" | "tag_id", ExtArgs["result"]["contentTag"]>
...
export interface ContentTagDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const contentTagWithContent_idOnly = await prisma.contentTag.findMany({ select: { content_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ContentTags and only return the `content_id`
   * const contentTagWithContent_idOnly = await prisma.contentTag.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ContentTags and only return the `content_id`
   * const contentTagWithContent_idOnly = await prisma.contentTag.updateManyAndReturn({
   *   select: { content_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ContentTagFieldRefs {
  readonly content_id: Prisma.FieldRef<"ContentTag", 'String'>
  readonly tag_id: Prisma.FieldRef<"ContentTag", 'String'>
}
